...
<script>
          function cerrarsesion(){
            var respuesta=confirm("¿Deseas cerrar sesión?")
            return respuesta
          }
</script>
...
<form action="{{route('create.delegate')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
  <h2 class="p-2 text-secondary text-center"><b>REGISTRO CANDIDATOS</b></h2>
  
 @csrf
  
 
 <div class="mb-3 w-100" title="Este campo es obligatorio">
  <label for="agencia" class="form-label fw-semibold">AGENCIA<span class="text-danger" style="font-size:20px;">*</span></label>
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="cedula" class="form-label fw-semibold">TARJETON<span class="text-danger" style="font-size:20px;">*</span></label>
    <input type="text" class="form-control" name="NoTarjeton" id="NoTarjeton" required autocomplete="off">
</div>
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
    ...
    <input type="text" class="form-control " name="Apellidos" id="Apellidos" required autocomplete="off">
  </div>

  <div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="Fecharegistro" class="form-label fw-semibold">FECHA REGISTRO <span class="text-danger" style="font-size:20px;">*</span></label>
    <input type="date" class="form-control" name="Fecharegistro" id="Fecharegistro" required autocomplete="off" min="{{ date('Y-m-d', strtotime('2023-09-01')) }}" max="{{ date('Y-m-d') }}">
</div>

<div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="Horaregistro" class="form-label fw-semibold">HORA REGISTRO <span class="text-danger" style="font-size:20px;">*</span></label>
    <input type="time" class="form-control" name="Horaregistro" id="Horaregistro" required autocomplete="off" placeholder="HH:MM">
</div>


  <div class="text-center">
    <button onclick="" id="agregar" type="submit" class="btn btn-primary w-50" name="btnregistrar" value="ok" style="background-color: #005E56;" name="registrar">Registrar</button>
    </div>
        ...
        <table id="personas" class="hover table table-striped shadow-lg mt-4 table-bordered table-hover col-md-1 p-1">
          <thead class="" style="background-color: #005E56;">
            <tr class="text-white">
              ...
              <th class="" scope="col">#</th>
              <th class="" scope="col">POSICION</th>
              <th class="" scope="col">AGENCIA</th>
              <th class="" scope="col">NO TARJETON</th>
 ...
 var table = $('#personas').DataTable({
  ...
  "columns": [
    ...
    {    data: null,
      ...
      var deleteButton = '<a onclick="return confirmar()" href="{{ route('delegate.delete', ':id') }}" type="submit" class="btn btn-small btn-danger" name="eliminar" value="ok"><i class="fa-solid fa-trash"></i></a>'.replace(':id', row.ID);
